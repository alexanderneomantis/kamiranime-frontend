...
export default function Lamparas() {
  ...
  const {data, loading, search} = useGetProductsByCategory('lamparas');
...
`
  ...
  return (
    <RootStyle title='Lamparas | Kamiranime'>
      <BreadCrumb/>
      <Container>
        <Grid container>
          <Grid item xs={12} md={3}>
            <FiltersDesktop category='lamparas' setFilters={setFilters} filters={filters} range={range} setRange={setRange}/>
