...
export default function Peluches() {
  ...
  const {data, loading, search} = useGetProductsByCategory('peluches');
...
`
  ...
  return (
    <RootStyle title='Peluches | Kamiranime'>
      <BreadCrumb/>
      <Container>
        <Grid container>
          <Grid item xs={12} md={3}>
            <FiltersDesktop category='peluches' setFilters={setFilters} filters={filters} range={range} setRange={setRange}/>
